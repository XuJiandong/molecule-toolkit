...
int main(int argc, const char* argv[]) {
  ...
  {
    const uint8_t expected[] = {
        ____, 0x34, ____, ____, ____, 0x12, ____,
    };
  ...
  {
    const uint8_t expected[] = {
        0x03, ____, ____, ____, 0x12, 0x34, 0x56,
    };
    // vector Bytes <byte>;
  ...
  {
    const uint8_t expected[] = {
        0x03, ____, ____, ____, ____, 0x12, ____,
        ____, 0x12, ____, ____, 0x12, ____,
    };
  ...
  {
    const uint8_t expected[] = {
        0x25, ____, ____, ____, 0x10, ____, ____, ____, 0x17, ____,
        ____, ____, 0x1e, ____, ____, ____, 0x03, ____, ____, ____,
        0x12, 0x34, 0x56, 0x03, ____, ____, ____, 0x12, 0x34, 0x56,
        0x03, ____, ____, ____, 0x12, 0x34, 0x56,
    };
  ...
  {
    const uint8_t expected[] = {
        0x03, ____, ____, ____, 0x03, ____, ____, ____, 0x12, 0x34, 0x56,
    };
    MolBuilder_UnionA_init(&b);
